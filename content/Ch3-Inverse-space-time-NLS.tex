...
\end{equation}
利用上面渐近行为, 以及对应特征问题 \eqref{eq:reverse-x-NLS-eigenvalue}-\eqref{eq:reverse-x-NLS-adjoint-eigenvalue}, 我们可以利用对称关系求解\cref{thm:NLS-inverse-x}-\cref{thm:NLS-inverse-x-t}
